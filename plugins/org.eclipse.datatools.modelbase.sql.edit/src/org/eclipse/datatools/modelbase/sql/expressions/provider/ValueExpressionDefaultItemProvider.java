...
public class ValueExpressionDefaultItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueExpressionDefault_SQL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueExpressionDefault_SQL_feature", "_UI_ValueExpressionDefault_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ValueExpressionDefault"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ValueExpressionDefault_type") :
			label;
	}
