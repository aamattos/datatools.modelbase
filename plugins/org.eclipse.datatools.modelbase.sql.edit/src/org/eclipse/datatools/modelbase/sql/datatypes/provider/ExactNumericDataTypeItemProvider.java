...
public class ExactNumericDataTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExactNumericDataType_scale_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExactNumericDataType_scale_feature", "_UI_ExactNumericDataType_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ExactNumericDataType_type") :
			label;
	}
