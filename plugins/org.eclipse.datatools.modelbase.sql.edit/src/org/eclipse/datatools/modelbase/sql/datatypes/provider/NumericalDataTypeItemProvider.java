...
public class NumericalDataTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NumericalDataType_precision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NumericalDataType_precision_feature", "_UI_NumericalDataType_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_NumericalDataType_type") :
			label;
	}
