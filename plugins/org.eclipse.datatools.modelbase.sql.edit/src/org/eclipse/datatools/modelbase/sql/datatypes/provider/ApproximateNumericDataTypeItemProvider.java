 ...
 * </copyright>
 *
 * $Id: ApproximateNumericDataTypeItemProvider.java,v 1.8 2011/08/18 14:30:50 aalvamat Exp $
 */
...
public class ApproximateNumericDataTypeItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ApproximateNumericDataType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ApproximateNumericDataType_type") :
			label;
	}
