		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArrayDataType_maxCardinality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArrayDataType_maxCardinality_feature", "_UI_ArrayDataType_type"),
